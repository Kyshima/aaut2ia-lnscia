...
Model_Checkpoint = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Crop_illness/cnn_crop_illness_detection.keras',
    monitor='val_loss', 
    save_best_only='True',
    verbose=1
)
...
tuner = RandomSearch(
    ...
    directory='C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Crop_illness/HyperparametersTests/cnn_crop_illness_detection_hyper',  # Directory to store the tuning results
