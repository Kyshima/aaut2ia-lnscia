...
Model_Checkpoint = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Illness/Final_Models/Models_Exported/cnn_illness1.keras',
    monitor='val_loss', 
    save_best_only='True',
    verbose=1
)
...
with open('training_history1_illness.pkl', 'wb') as file:
