...
Model_Checkpoint = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Illness/Final_Models/Models_Exported/cnn_illness3.keras',
    monitor='val_loss', 
    save_best_only='True',
    verbose=1
)
...
with open('training_history3_illness.pkl', 'wb') as file:
