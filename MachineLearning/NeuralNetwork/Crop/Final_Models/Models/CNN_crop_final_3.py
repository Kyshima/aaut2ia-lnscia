...
model.add(keras.layers.Conv2D(48, (3, 3), activation='relu', padding='same', input_shape=(128, 128, 3)))
...
Model_Checkpoint = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Crop/Final_Models/Models_Exported/cnn_crop3.keras',
    monitor='val_loss', 
    save_best_only='True',
    verbose=1
)
...
with open('training_history3_crop.pkl', 'wb') as file:
