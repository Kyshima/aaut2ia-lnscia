...
model.add(keras.layers.Conv2D(48, (5, 5), activation='relu', padding='same'))
model.add(keras.layers.MaxPooling2D(pool_size=(3, 2)))
...
Model_Checkpoint = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Crop/Final_Models/Models_Exported/cnn_crop2.keras',
    monitor='val_loss', 
    save_best_only='True',
    verbose=1
)
...
with open('training_history2_crop.pkl', 'wb') as file:
