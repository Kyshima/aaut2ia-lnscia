...
tuner = RandomSearch(
    ...
    directory='C:/Users/Diana/Documents/aaut2ia-lnscia/MachineLearning/NeuralNetwork/Crop/Models_Train_Hyper/HyperparametersTests/cnn_crop1_hyper',  # Directory to store the tuning results
